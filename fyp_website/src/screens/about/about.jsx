...
const About = () => {
  ...
  return (
    <div className="about-page">
      <Matrix />
      <h1 className="page-title">Sentinel watchgaurd AI</h1>
      <p className="who-we-are">We are Sentinel watchgaurd AI, a leading provider of AI-powered CCTV cameras that help businesses and organizations detect and analyze human emotions in real-time. By using our cutting-edge technology, you can monitor customer satisfaction, reduce wait times, and improve overall customer experience.</p>
      ...
      <div className="team-section">
        ...
        <div className="team-member">
          ...
          <p className="team-member-bio">Jalal Ghannam is a visionary entrepreneur with a passion for technology and innovation. He and his team founded Sentinel watchgaurd AI with the goal of using AI technology to improve public safety and security.</p>
        </div>
        <div className="team-member">
