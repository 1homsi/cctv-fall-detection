          ...
          <div className="productsContent">
            ...
            {isOn ? (
              <div className="displayProductsNormal">
                <div className="prodOuter">
                  <img src={fall} alt="fall-detection" border="0" />
                  <h3>Fall Detection</h3>
                  <div className="blackline"></div>
                  <p>
                    Imagine a device that uses CCTVs to monitor your movements
                    and acts as a guardian, ready to assist if you start to
                    fall. It can deploy safety measures and call for help in
                    case of emergency, making it like having a superhero
                    protecting you.
                  </p>
                  <h3>{monthly ? "100$ / month" : "1150$ / year"}</h3>
                  <button>Get Now!</button>
                ...
                <div className="prodOuter">
                  <img src={face} alt="face-detection" border="0" />
                  <h3>Emotion Detection</h3>
                  <div className="blackline"></div>
                  <p>
                    Imagine a tool that can read people's emotions accurately,
                    like a mind-reading machine. This tool is designed to detect
                    and analyze the emotional state of customers, allowing
                    businesses to measure their satisfaction levels and respond
              ...
              <div className="displayProductsPro">
                <div className="product">
                  <div className="product-right">
                    ...
                    <div className="blackline"></div>
                    <p>
                      This advanced AI not only protects you from falls but also
                      detects your emotional state to gauge your satisfaction as
                      a customer. It can pick up on subtle cues like facial
                      expressions, tone of voice, and body language, providing
                      businesses with real-time feedback to help them improve
                      customer service. It's like having a personal guardian
                      angel and a secret weapon for customer satisfaction rolled
                      into one.
                    </p>
                    <div className="buy">
                      <h3>{monthly ? "230$ / month" : "2700$ / year"}</h3>
