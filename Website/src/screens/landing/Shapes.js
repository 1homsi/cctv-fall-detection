...
export function Lights() {
  return (
    <>
      <spotLight color="#7fffd4" position={[-10, -10, -10]} intensity={0.2} />
      <spotLight color="#7fffd4" position={[-10, 0, 15]} intensity={0.8} />
      <spotLight color="#7fffd4" position={[-5, 20, 2]} intensity={0.5} />
      <spotLight color="#c9ffed" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#c9ffed" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#c70f46" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}
